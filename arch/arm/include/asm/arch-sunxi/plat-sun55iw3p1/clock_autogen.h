...
struct CCMU_st {
	...
	uint32_t spi0_clk_cfg;//spi0 clock register
	uint32_t spi1_clk_cfg;//spi1 clock register
	uint32_t spi2_clk_cfg;//spi2 clock register
	uint32_t pad_until_0x0950[1];
	uint32_t spif_clk_cfg;//spif clock register
	uint32_t pad_until_0x096c[6];
	uint32_t spi_gate_reset;//spi bus gating reset register
