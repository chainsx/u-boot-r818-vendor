...
const struct flash_info spi_nor_ids[] = {
	...
	{ INFO("en25qh64a", 0x1c7017, 0, 64 * 1024,  128,
			SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	{ INFO("en25qh128",  0x1c7018, 0, 64 * 1024,  256,
			SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	...
	{
		INFO("gd25q256", 0xc84019, 0x0, 64 * 1024, 512,
			SECT_4K | SPI_NOR_DUAL_READ |
			SPI_NOR_HAS_LOCK | SPI_NOR_HAS_TB |
			SPI_NOR_4B_OPCODES)
	},
	{
		INFO("gd25f256f", 0xc84319, 0x0, 64 * 1024, 512,
			SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			SPI_NOR_4B_OPCODES | USE_IO_MODE | USE_RX_DTR)
	},
	{
	...
	{ INFO("p25q128", 0x856018, 0x0, 64 * 1024, 256, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	{ INFO("p25q128h", 0x852018, 0x0, 64 * 1024, 256,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
			USE_IO_MODE | USE_RX_DTR) },
#endif
	...
	{INFO("fm25w128",   0xa12818, 0x0,	64 * 1024,    256, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
#endif
#ifdef CONFIG_SPI_FLASH_XT
	/* XTX */
	{ INFO("xt25p1288", 0x0b4018, 0, 64 * 1024, 256,
			SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
#endif
	/*BOYA*/
	{ INFO("BY25Q128", 0x684018, 0, 64 * 1024,  256, SECT_4K | SPI_NOR_DUAL_READ) },

	/*Adesto*/
	{ INFO("at25sf128a", 0x1f8901, 0, 64 * 1024, 256, SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
	...
	/*GFX*/
	{ INFO("GM25Q64A", 0x1c4017, 0, 64 * 1024, 128, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ) },
